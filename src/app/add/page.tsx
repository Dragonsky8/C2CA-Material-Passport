...
export default function AddPage() {
    ...
    const handleInputChange = (e: any) => {
        const fieldInfo: FieldType = {name: e.currentTarget.id, value: e.currentTarget.value}
        setInputValues(prevState => ({ ...prevState, [fieldInfo.name]: fieldInfo.value }))
      }
    const handleSubmit = () => {
  ...
  return (
    <CardBody>
      <>
        ...
        >
          <TextField id="name" label="Name" variant="filled" onChange={handleInputChange}/>
          <TextField id="producer" label="Producer" variant="filled" onChange={handleInputChange}/>
          <TextField id="mixture" label="Mixture" variant="filled" onChange={handleInputChange}/>
        </Box>
        <Box>
