    ...
    <CardBody>
      <>
        ...
        >
          ...
          >
            {Object.keys(pageText).map((pageName: string) => (
              <Box sx={{
                display: 'flex',
                flexGrow: 1,
                flexShrink: 1,
              ...
              <MediaCard title={pageName} cardText={pageText[pageName as keyof typeof pageText]} link={`${params.id}/${pageName.toLowerCase()}`}/>
              </Box>
            ))}
          </Box>
        </Box>
