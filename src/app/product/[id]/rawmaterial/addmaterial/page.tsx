...
export default function AddPage({
  ...
  const handleProductChange = async (event: React.MouseEvent) => {
    ...
    const bodyPatch = { userId: userId, data: {id: params.id}, link: inputValues };

    const res = await fetch(`/api/entity/allmaterials/${2}`, {
      method: "POST",
      headers: {
      ...
      <>
        ...
        >
          <Typography variant="h6">
            Add new materials to the product, by scanning the raw material ID tags.
          </Typography>
